   ...
   public partial class AppConst
    {
        ...
        {
            public const string AppClaimTypeBase = "http://dci.mnm.mwa/identity/claims/";
            public const string CurrentSessionId = AppClaimTypeBase + "current-session-id";
            public const string Operation = AppClaimTypeBase + "Operation";
            public const string UserId = AppClaimTypeBase + "User-id";
            public const string UMAToken = AppClaimTypeBase + "uma-token";
            public const string UMARefreshToken = AppClaimTypeBase + "uma-r-token";
            public const string UMATokenExpiration = AppClaimTypeBase + "uma-token-expire";
            public const string UMAID = AppClaimTypeBase + "uma-id";

            #region Standard Claim Types
